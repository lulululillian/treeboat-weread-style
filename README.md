...
> **💡 AI 助手快速上手（推荐）**
>
> 本模板专为 AI 助手协作设计，你不需要懂命令行，只需要会跟 AI 说话：
> - **首次配置**：把解压后的文件夹发给 AI，说「帮我按 README 配置这个微信读书阅读看板」
> - **后续更新**：把项目文件夹发给 AI，说「帮我更新到最新版本」
>
> AI 会自动完成所有操作，你的配置和主题选择不会丢失。
...
2. 把整个文件夹路径发给你的 AI 助手，告诉它「帮我按 README 配置这个舟读微信读书 Obsidian 阅读看板」；
